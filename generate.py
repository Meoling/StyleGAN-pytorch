...
if __name__ == '__main__':
    ...
    #     utils.save_image(img, f'output/sample_{i}.png', nrow=args.n_col, normalize=True, range=(-1, 1))
    epoch=1
    for j in range(100):
        img = style_mixing(generator, step, mean_style, args.n_col, args.n_row, device)
        utils.save_image(
            img, f'output/sample_mixing_{epoch}_{j}.png', nrow=args.n_col + 1, normalize=True, range=(-1, 1)
        )
